...
export const REGISTRY: PackageEntry[] = [
  ...
  },
  {
    ...
    tagline: "Vision analysis, extraction, and comparison — with source lineage per field.",
    domain: "vision.zoidlab.ai", glyph: "👁", accent: "#f472b6",
    required_plan: "pro", release_channel: "prototype", status: "planned", health_path: "/api/health",
    capabilities: ["vision-analysis", "field-extraction", "comparison"],
  ...
  },
  {
    ...
    tagline: "Voice agent design, simulation, and telephony integration.",
    domain: "voice.zoidlab.ai", glyph: "🎙", accent: "#fb7185",
    required_plan: "pro", release_channel: "prototype", status: "planned", health_path: "/api/health",
    capabilities: ["voice-agents", "simulation", "telephony"],
  ...
  },
  {
    ...
    tagline: "MCP discovery, testing, permissions, and certification.",
    domain: "mcp.zoidlab.ai", glyph: "🔌", accent: "#a78bfa",
    required_plan: "pro", release_channel: "prototype", status: "planned", health_path: "/api/health",
    capabilities: ["connector-discovery", "sandbox-test", "certification", "health"],
  ...
  },
  {
    ...
    tagline: "Multi-agent collaboration and orchestration — deployable as a Builder capability.",
    domain: "swarm.zoidlab.ai", glyph: "🐝", accent: "#facc15",
    required_plan: "pro", release_channel: "prototype", status: "planned", health_path: "/api/health",
    capabilities: ["multi-agent", "handoff-contracts", "budget-limits", "replay"],
